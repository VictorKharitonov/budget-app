            ...
            <ListItemText
              primary={
                <Box className={cl.listItemTextContainer}>
                  <Typography variant="body1" noWrap={true} className={cl.listItemText}>
                    {envelope.name}
                  </Typography>
                  <Badge
                    badgeContent={fcLatter(envelope.status)}
                    color={colorStatus[envelope.status]}
                    className={cl.listItemStatus}
                  />
                </Box>
              }
            />
